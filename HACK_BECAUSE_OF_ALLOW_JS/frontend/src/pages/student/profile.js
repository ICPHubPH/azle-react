...
import { LogOut, Settings, Pencil, AlertTriangle } from "lucide-react";
              ...
              <div className="flex-1 md:right-10  ">
                <Tabs defaultValue="saved">
                  ...
                  <TabsContent value="saved">
                    ...
                    {savedScholarships.map((scholarship) => (<Card key={scholarship.id} className="mb-4">
                        <CardHeader>
                      ...
                      <CardContent>
                        ...
                        <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
                          ...
                          <DialogContent className="sm:max-w-[400px]">
                            ...
                            <div className="py-4">
                              <Input value={deleteConfirmation} onChange={(e) => setDeleteConfirmation(e.target.value)} placeholder={`Type "${user.name}" to confirm`} className="w-full"/>
                            </div>
                            <DialogFooter>
                              <Button variant="outline" onClick={() => setIsDeleteModalOpen(false)}>
                                Cancel
                              </Button>
                              <Button variant="destructive" onClick={handleDeleteAccount} disabled={deleteConfirmation !== user.name}>
                                Delete Account
                              </Button>
                            </DialogFooter>
                          </DialogContent>
