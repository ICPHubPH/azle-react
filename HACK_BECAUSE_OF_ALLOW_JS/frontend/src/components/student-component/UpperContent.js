...
const UpperContent = () => {
    ...
    return (<div className="flex justify-center py-10  rounded-lg ">
      <div className='flex flex-col items-center text-center max-w-2xl  '>
        ...
        <div className="relative w-full max-w-md">
          <input type="text" className="w-full px-5 py-3 pl-12 border border-transparent shadow-lg rounded-full text-slate-800 dark:text-slate-100 bg-white dark:bg-slate-800 focus:outline-none focus:ring-4 focus:ring-slate-400 dark:focus:ring-slate-500 transition-all" placeholder="Search for opportunities..." value={searchQuery} onChange={handleSearchChange}/>
