...
const TopProviderCard = ({ id, // Get the id from props
thumbnail, provider, description, scholarship, avatar, }) => {
    ...
    return (<Card className="w-full overflow-hidden">
      <CardHeader className="p-0">
        <div className="relative h-48">
          <img src={thumbnail} alt="Scholarship background" className="w-full h-full object-cover"/>
